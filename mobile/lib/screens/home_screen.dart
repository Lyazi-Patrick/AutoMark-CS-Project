    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child:
              dashboardProvider.isLoading || isLoadingUser
                  ...
                  : ListView(
                    ...
                    children: [
                      ...
                      _buildStatCard(
                        title: "Answer Key",
                        value:
                            dashboardProvider.answerKeyAvailable
                                ? "Available"
                                : "Not Found",
                        icon: Icons.key,
                        color:
                      ...
                      // Only shows the Premium Card if not premium
                      if (!isPremium)
                        _buildStatCard(
